...
swiftc -module-cache-path "$MODULE_DIR/cache" -parse-as-library -swift-version 6 -target "$(uname -m)-apple-macosx26.0" \
  ...
  Tests/DayreedUITests/LiveServiceChecks.swift Tests/DayreedUITests/ReportServiceChecks.swift \
  Tests/DayreedUITests/ProviderServiceChecks.swift -o "$TEST_DIR/checks"
"$TEST_DIR/checks"
