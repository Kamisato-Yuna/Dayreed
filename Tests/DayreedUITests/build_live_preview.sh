...
p={'CFBundleExecutable':'DayreedLivePreview','CFBundleIdentifier':'YunaBuild.Dayreed.LivePreview','CFBundleName':'Dayreed Live Preview','CFBundleShortVersionString':'1.0.0','CFBundleVersion':'1','CFBundlePackageType':'APPL','NSPrincipalClass':'NSApplication','LSMinimumSystemVersion':'26.0','NSHighResolutionCapable':True}
