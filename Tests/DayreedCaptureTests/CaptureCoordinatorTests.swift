...
@MainActor @Test func initializationAndAllOffNeverCollectOrPrompt() async throws {
    ...
    #expect(!fixture.coordinator.state.hasCheckedPermissions)
    #expect(fixture.environment.handler == nil)
    fixture.coordinator.refreshPermissions()
    #expect(fixture.coordinator.state.hasCheckedPermissions)
    #expect(fixture.coordinator.state.permissions == fixture.environment.allowed)
    #expect(fixture.environment.permissionQueries == 1)
    #expect(fixture.environment.permissionRequests == 0)
    #expect(fixture.environment.screenshotCalls == 0 && fixture.environment.historyCalls == 0)
    #expect(fixture.environment.handler == nil)
